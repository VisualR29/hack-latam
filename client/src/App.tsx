        ...
        <div className="mt-auto px-xs pt-md border-t border-outline-variant">
          <div className="flex items-center gap-sm">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="font-body-md text-[12px] text-on-surface-variant truncate">{user ? (user.displayName ?? user.email) : "security@vibeguard.io"}</span>
          ...
          {!result ? (
            ...
            <div className="w-full max-w-7xl mx-auto space-y-lg animate-fade-in">
              ...
              <div className="relative bg-surface-container-high rounded-xl p-lg inner-glow overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col gap-lg md:flex-row md:items-center md:justify-between">
                  <div className="space-y-sm text-center md:text-left md:flex-1 md:min-w-0">
                    ...
                    <p className="font-body-md text-on-surface-variant max-w-xl leading-relaxed mx-auto md:mx-0">Tu código ha sido auditado según los estándares del Top 10 de OWASP. La puntuación refleja las necesidades inmediatas de corrección.</p>
